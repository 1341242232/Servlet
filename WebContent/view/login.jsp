...
<script type="text/javascript" src="/OA_products/jquery/jquery-3.4.1.min.js"></script>
...
$(function(){
	$("#bnt").click(function(){
		...
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath}/doUserServer",
			async:true,
			traditional:true,
			dateType:"json",
			...
			success:function(result){
					if (result.success) {
						...
						window.location.href="http://localhost:8090/OA_products/view/index/index.jsp";
					}
			},
